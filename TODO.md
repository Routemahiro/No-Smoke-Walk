...
- [x] ブログ機能の完全削除（費用対効果が低いため撤去。SNS運用にリソース集中）(2026-03-05 完了)
...
- [x] 位置情報の許可ダイアログが毎回出る問題を改善（バランス案: 保存位置→許可済みのみ自動更新。周辺デフォルト半径400m）(2026-02-03 完了)
- [x] Supabase接続復旧（プロジェクトpaused→resume。Workers `/api/heatmap` の530解消）(2026-02-03 完了)
